 ...
 */
package org.lastaflute.di.mockapp.nondi;
 ...
 * @author jflute
 */
public class MockNondiSeaLogic {

    private static final Logger logger = LoggerFactory.getLogger(MockNondiSeaLogic.class);

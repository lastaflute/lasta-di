 ...
 * @author jflute
 */
public class MockCleanEgInteractor implements MockCleanEgUseCase {

    private static final Logger logger = LoggerFactory.getLogger(MockCleanEgInteractor.class);

    @Resource
    private MockCleanEgRepository cleanArcRepository;

...
import org.dbflute.lasta.jta.core.TransactionImpl;
import org.dbflute.lasta.jta.core.xa.DefaultXAResource;
...
public class TransactionImplTest extends TestCase {
    ...
    private class Sync implements Synchronization {
        ...
        public void afterCompletion(int status) {
            assertEquals(Status.STATUS_NO_TRANSACTION, LjtTransactionUtil.getStatus(tx_));

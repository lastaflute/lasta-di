...
public class IllegalAutoBindingPropertyRuntimeException extends SRuntimeException {
    ...
    public IllegalAutoBindingPropertyRuntimeException(Class<?> componentClass, String propertyName) {
        super("ESSR0080", new Object[] { componentClass.getName(), propertyName });

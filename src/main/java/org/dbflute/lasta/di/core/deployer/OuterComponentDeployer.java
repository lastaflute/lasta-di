...
public class OuterComponentDeployer extends AbstractComponentDeployer {
    ...
    /**
     * @see org.dbflute.lasta.di.core.deployer.ComponentDeployer#deploy()
     */
    ...
    /**
     * @see org.dbflute.lasta.di.core.deployer.ComponentDeployer#init()
     */
    public void init() {
    }

    /**
     * @see org.dbflute.lasta.di.core.deployer.ComponentDeployer#destroy()
     */
    public void destroy() {
    }
}

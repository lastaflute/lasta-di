...
import org.dbflute.lasta.di.core.aop.LaMethodInvocation;
...
import org.dbflute.lasta.di.core.aop.impl.NestedMethodInvocation;
import org.dbflute.lasta.di.core.aop.interceptors.AbstractInterceptor;
...
public class AspectCustomizer extends AbstractCustomizer {
     ...
     * <p>
     * このインターセプタは呼び出されると、 構築時に指定されたインターセプタを{@link org.dbflute.lasta.di.core.LaContainer}から取得して処理を引き渡します。

 ...
 */
package org.dbflute.lasta.di.core.expression.engine;
...
import org.dbflute.lasta.di.core.exception.ExpressionClassCreateFailureException;
...
public class JavaScriptExpressionEngine implements ExpressionEngine {
    ...
    public String resolveStaticMethodReference(Class<?> refType, String methodName) {
        return refType.getName() + "." + methodName; // e.g. org.dbflute.lasta.di.util.LdiResourceUtil.exists
    }
}

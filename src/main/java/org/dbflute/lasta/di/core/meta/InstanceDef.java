 ...
 * <dd>コンポーネントのインスタンスは{@link LaContainer}の外で生成し、 インジェクションだけを行ないます。
 ...
 * <dt>Tigerアノテーション</dt>
 * <dd><code>&#064;</code>{@link org.dbflute.lasta.di.core.annotation.Component}の<code>instance</code>値で指定します。</dd>
 * </dl>
 * インスタンス定義を省略した場合は<code>singleton</code>を指定したことになります。
 * </p>
 * <p>
 * <code>application</code>、 <code>request</code>、 <code>session</code>を使う場合は、
 * {@link LaContainer#init()}を行なう前に{@link ExternalContext}をS2コンテナに設定する必要があります。
 * </p>
 * 

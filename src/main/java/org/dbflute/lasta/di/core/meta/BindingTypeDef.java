 ...
 * <dd>{@link org.dbflute.lasta.di.core.meta.AutoBindingDef 自動バインディングタイプ定義}が<code>auto</code>や<code>property</code>の場合でも自動バインディングを適用しません。</dd>
 * </dl>
 * 
...
public interface BindingTypeDef {
     ...
     * @param component
     *            対象となるコンポーネントのインスタンス
     * @throws org.dbflute.lasta.di.helper.beans.exception.IllegalPropertyRuntimeException
     ...
     * @throws org.dbflute.lasta.di.helper.beans.exception.IllegalPropertyRuntimeException
     *             <code>propertyDef</code>に指定されたコンポーネントが取得できなかった場合
     * @throws org.dbflute.lasta.di.exception.IllegalAccessRuntimeException

 ...
 */
package org.dbflute.lasta.di.core.smart.warm;

import org.dbflute.lasta.di.core.ComponentDef;
import org.dbflute.lasta.di.core.LaContainer;
import org.dbflute.lasta.di.core.creator.ComponentCreator;
import org.dbflute.lasta.di.core.factory.SingletonLaContainerFactory;
import org.dbflute.lasta.di.core.meta.impl.LaContainerBehavior.DefaultProvider;
import org.dbflute.lasta.di.core.util.ComponentUtil;
import org.dbflute.lasta.di.helper.log.SLogger;
import org.dbflute.lasta.di.naming.NamingConvention;

/**
 * WARM deploy時にコンポーネントを自動登録する{@link org.dbflute.lasta.di.core.factory.LaContainerFactory.LaContainerProvider}の実装です。
 * 

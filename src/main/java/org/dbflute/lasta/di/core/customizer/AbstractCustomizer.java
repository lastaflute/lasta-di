...
import org.dbflute.lasta.di.core.autoregister.ClassPattern;
import org.dbflute.lasta.di.util.LdiClassUtil;

/**
 * {@link org.dbflute.lasta.di.core.ComponentDef コンポーネント定義}をカスタマイズするコンポーネントカスタマイザの抽象クラスです。
 * <p>
 * カスタマイズ対象となるコンポーネントおよびカスタマイズ非対象のコンポーネントを{@link org.dbflute.lasta.di.core.autoregister.ClassPattern クラスパターン}で指定することができます。

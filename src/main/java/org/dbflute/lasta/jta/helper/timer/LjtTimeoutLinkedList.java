 ...
 */
package org.dbflute.lasta.jta.helper.timer;
 ...
 */
public class LjtTimeoutLinkedList implements Cloneable, Externalizable {
    ...
    public Object clone() {
        LjtTimeoutLinkedList copy = new LjtTimeoutLinkedList();
        for (Entry e = header._next; e != header; e = e._next) {

 ...
 */
package org.dbflute.lasta.jta.core.xa;
...
public class XidImpl implements Xid, Serializable {
    ...
    private byte[] createGlobalId() {
        return convert64bytes((GLOBAL_ID_BASE + Integer.toString(hashCode)).getBytes());
    }
    ...
    public String toString() {
        return "[FormatId=" + FORMAT_ID + ", GlobalId=" + new String(globalId).trim() + ", BranchId=" + new String(branchId).trim() + "]";
    }
